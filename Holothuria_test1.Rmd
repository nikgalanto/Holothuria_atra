...
Put the metadata in the same order as the genetic data, and only keep the sequences that are still found in the metadata after we 
removed the ones from pops with n < 5
